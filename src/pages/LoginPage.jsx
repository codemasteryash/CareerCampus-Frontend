...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080c14] flex items-center justify-center relative overflow-hidden">
      ...
      {/* Background glows — matching landing page signature */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-15%] left-[-10%] w-[600px] h-[600px] rounded-full bg-blue-600/20 blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-cyan-500/15 blur-[100px]" />
        <div className="absolute top-[40%] left-[40%] w-[300px] h-[300px] rounded-full bg-blue-800/10 blur-[80px]" />
        {/* Grid */}
        <div
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-[#0f1623]/90 backdrop-blur-xl border border-[#1e2d45] rounded-2xl p-8 shadow-2xl shadow-black/60">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-[#64748b] mt-1">Sign in to your CareerCompass account</p>
          </div>
